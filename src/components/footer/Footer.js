          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-5">
              ...
              >
                ...
                <span className="hover:text-purple-600 transition-colors duration-300">+1 (123) 456-7890</span>
              </motion.li>
              <motion.li 
                className="flex items-start"
                initial={{ opacity: 0, x: -20 }}
              ...
              >
                ...
                <span className="hover:text-purple-600 transition-colors duration-300">San Francisco, CA</span>
              </motion.li>
            </ul>
          </div>
